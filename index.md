...
| `PR0201`   | [Entorno contenerizado](./ut02_instalacion/practicas/pr0201.md)                         | **16/11/2025** | `RA2`     |
| **UT03** | **Implantación de ERP en la empresa**                                                                      |
| `PR0301`   | [Módulo facturación](./ut03_implantacion/pr0301.md)                                     | **23/11/2025** | `RA3` `RA4` |
| `PR0302`   | [Integración de servicios externos](./ut03_implantacion/pr0302.md)                      | **25/11/2025** | `RA3` `RA4` |
| **UT04** | **El lenguaje de programación Python**                                                                     |
| `PR0401`   | [Ejercicios básicos en Python](./ut04_python/pr0401_ejercicios_basicos.md)              | **25/10/2025** | `RA5`     |
| `PR0402`   | [Uso de cadenas en Python](./ut04_python/pr0402_cadenas.md)                             | **25/10/2025** | `RA5`     |
| `PR0403`   | [Trabajando con listas en Python](./ut04_python/pr0403_listas.md)                       | **01/11/2025** | `RA5`     |
| `PR0404`   | [Diccionarios en Python](./ut04_python/pr0404_diccionarios.md)                          | **09/11/2025** | `RA5`     |
| `PR0405`   | [Programación funcional](./ut04_python/pr0405_programacion_funcional.md)                | **02/12/2025** | `RA5`     |
...
| `PR0701`   | [PR0701: Página estática y dinámica](./ut07_web_controllers/pr0701_pagina_estatica_dinamica.md)| **15/02/2026** | `RA5`     |
| `PR0702`   | [PR0702: API REST](./ut07_web_controllers/pr0702_api_rest.md)                           | **15/02/2026** | `RA5`     |
| **----** | **Proyecto**                                                                          |
| `PROYECTO`   | [Proyecto Final SGE](./proyectos/proyecto_curso_2025-26.md)| **22/02/2026** | `RA5`     |
|                                                                                                                       |
| | **PRÁCTICAS DE REPASO**                                                                                             |
| `REP01`    | [REP01: Gestión de un taller mecánico](./repaso/rep01_gestion_taller.md)            |
| `REP02`    | [REP02: Gestión de una biblioteca escolar](./repaso/rep02_biblioteca.md)            |
| `REP03`    | [REP03: Gestión de proyectos software](./repaso/rep03_proyectos_sw.md)              |
| `REP04`    | [REP04: Gestión de un hospital veterinario](./repaso/rep04_gestion_hospital.md)     |
| `REP05`    | [REP05: Gestión de un club deportivo](./repaso/rep05_club_deportivo.md)             |
| `REP06`    | [REP06: Gestión de una tienda de electrónica](./repaso/rep06_tienda_electronica.md) |
